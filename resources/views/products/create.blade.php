...
<x-container class="items-center justify-center flex flex-col">
    <div class="bg-gray-200 items-center rounded-xl flex max-w-150 w-full gap-10 flex-col p-10">
        <h1 class="text-3xl">Создание нового продукта</h1>
        <form class=" flex flex-col w-full gap-5 mx-auto" action="{{route('products.store')}}" method="post" enctype="multipart/form-data"+>
            @csrf
